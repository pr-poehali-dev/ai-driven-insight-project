        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              <a
                href="#features"
                className="font-geist text-white hover:text-purple-500 transition-colors duration-200"
              >
                Вкусы
              </a>
              <a href="#applications" className="font-geist text-white hover:text-purple-500 transition-colors duration-200">
                Линейки
              </a>
              <a href="#faq" className="font-geist text-white hover:text-purple-500 transition-colors duration-200">
                Вопросы
              </a>
            </div>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-black/98 border-t border-purple-500/20">
              <a
                href="#features"
                className="block px-3 py-2 font-geist text-white hover:text-purple-500 transition-colors duration-200"
